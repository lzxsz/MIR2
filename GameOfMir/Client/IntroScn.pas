...
begin
   ...
   with m_EdPasswd do begin      //密码输入框
      Left   := 495;
      Top    := 511;
      Height := 19;
      Width  := 112;
...
begin
   ...
   if Sender = m_EdPhone then begin
      ...
      FrmDlg.NAHelps.Add ('例如 027-63287003');
      FrmDlg.NAHelps.Add ('');
   end;
...
begin
   ...
   if index = 0 then begin
      ...
      FrmDlg.DCreateChr.Top := 63; //////****选择人物筐;
   end else begin
   ...
   EdChrName.Left := FrmDlg.DCreateChr.Left + 63;   //////****选择人物筐名字;
